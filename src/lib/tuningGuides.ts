...
export const TUNING_GUIDES: TuningGuide[] = [
...

  {
    ...
    parameters: {
      ...
      note:              "RWD is required for a competitive drift build. AWD can drift but initiating and sustaining angle for scoring is significantly harder",
    },
  },
...
export const DIVISION_GUIDES: DivisionGuide[] = [
  {
    ...
    priorities: [
      ...
      'Always fit aero — these cars are fast enough that downforce makes a measurable difference. Starting point: 40–45% front bias; add front aero if the car pushes wide, rear aero if it oversteers on exit',
      'Race diff (required for percentage tuning — Sport diff adds limited-slip without tuning access). Starting point: RWD 40–55% acceleration / 20–35% deceleration. AWD: 70–80% rear centre bias. Adjust in 2–3% increments.',
      'Damping starting point (heavy tarmac): rebound 9–11, bump 5–7 — stiffer than sports cars to control extra mass at speed',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Race diff (required for percentage tuning). Starting point: RWD 40–55% acceleration / 20–35% deceleration — lower end for technical circuits, higher for flowing layouts. Adjust in 2–3% increments.',
      'Rally suspension, rally tires, AWD (if convertible) for dirt — competitive at B and A class. AWD conversion is expensive — check the PI cost on your specific car before committing.',
  ...
  },
  {
    ...
    priorities: [
      'Race suspension at A class and above. At B class, weigh the PI cost against tires and brakes — those upgrades often matter more than full tuning access on a muscle car',
      'Wide rear tires, slick or semi-slick at A class and above — traction is always the limit',
      'Race diff (required for percentage tuning). Starting point: RWD 55–70% acceleration / 20–35% deceleration — higher acceleration lock than sports cars puts the torque to the ground. Adjust in 2–3% increments.',
      'Damping starting point (heavy muscle): rebound 10–12, bump 6–8 — muscle cars carry more weight and need firmer control over body movement',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Fit aero early — one of the most PI-efficient upgrades for this division. Starting point: 40–45% front bias; adjust if the car pushes wide or oversteers on exit',
      'Race diff (required for percentage tuning). Starting point: RWD 40–55% acceleration / 20–35% deceleration — consistent corner exits matter more than peak power with a heavy car. Adjust in 2–3% increments.',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Aero balance first — starting point 40–45% front. These cars generate significant downforce and balance is critical; adjust front/rear from there based on feel',
      'Race diff (required for percentage tuning). Starting point: 40–55% acceleration / 20–35% deceleration — track cars need precise diff tuning to match their extreme grip levels. Adjust in 2–3% increments.',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Diff starting point for loose surfaces: 30–50% acceleration / 20–30% deceleration — softer than road racing to prevent wheelspin on dirt. Adjust in 2–3% increments.',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Diff starting point: 50–70% acceleration / 20–35% deceleration — more aggressive than road racing to drive through loose terrain. Adjust in 2–3% increments.',
  ...
  },
  {
    ...
    priorities: [
      ...
      'Rear diff — acceleration lock 80–100% (the biggest factor in a consistent slide). Deceleration lock 30–60% — too high causes snap oversteer when lifting off throttle on corner entry. Increase decel lock carefully and test each increment.',
